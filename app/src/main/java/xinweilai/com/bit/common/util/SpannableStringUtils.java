...
/**
 * Created by 空 on 2017/4/21 0021.
 */
...
public class SpannableStringUtils {
    ...
    public static class Builder {
        ...
        private int defaultValue = 0x555555;
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(CommonUtil.getContext(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(CommonUtil.getContext(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(CommonUtil.getContext(), resourceId), start, end, flag);
                    resourceId = 0;
